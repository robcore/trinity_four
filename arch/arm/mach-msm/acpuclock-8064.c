...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[14] = { { 1134000, HFPLL, 1, 0x2A }, 1150000, 1150000, 5 },
        ...
        [17] = { { 1296000, HFPLL, 1, 0x30 }, 1150000, 1150000, 5 },
        [18] = { { 1350000, HFPLL, 1, 0x32 }, 1150000, 1150000, 5 },
	{ }
};
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15), 1125000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15),  1075000 },
...
static struct acpu_level tbl_fast[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15), 1025000 },
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15), 1000000 },
