...
static struct l2_level l2_freq_tbl[] __initdata __initdata = {
	[0]  = { {  384000, PLL_8, 0, 2, 0x00 }, 1025000, 1025000, 1 },
	[1]  = { {  432000, HFPLL, 2, 0, 0x20 }, 1025000, 1025000, 2 },
	[2]  = { {  486000, HFPLL, 2, 0, 0x24 }, 1025000, 1025000, 2 },
	[3]  = { {  540000, HFPLL, 2, 0, 0x28 }, 1025000, 1025000, 2 },
	[4]  = { {  594000, HFPLL, 1, 0, 0x16 }, 1025000, 1025000, 2 },
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	...
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(4),   925000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(4),   925000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(4),   050000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(4),   950000 },
	...
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(15), 1075000 },
